  ...
  return (
    <>
      ...
      <LogoVideo />
            ...
            {/* Navigation */}
      <nav className="absolute max-sm:top-24 max-sm:left-1/2 max-sm:transform max-sm:-translate-x-1/2 top-8 right-8 z-[9999] animate-on-scroll" style={{ position: 'absolute', zIndex: 9999 }}>
        <div className="glass rounded-2xl max-sm:p-2 max-sm:px-4 p-2">
          <div className="flex max-sm:gap-3 gap-2">
            <Link href="/design" className="text-white/70 max-sm:px-2 max-sm:py-1 px-4 py-2 max-sm:text-sm text-sm font-medium relative group transition-all duration-300 hover:text-white hover:scale-105 overflow-hidden rounded-full whitespace-nowrap">
            ...
            <Link href="/about" className="text-white/70 max-sm:px-2 max-sm:py-1 px-4 py-2 max-sm:text-sm text-sm font-medium relative group transition-all duration-300 hover:text-white hover:scale-105 overflow-hidden rounded-full whitespace-nowrap">
              <div className="absolute top-1/4 left-1/4 w-1/4 h-1/2 bg-gradient-to-r from-yellow-400/0 via-yellow-400/20 to-yellow-400/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-500 ease-out opacity-0 group-hover:opacity-100"></div>
              <span className="relative">درباره ما</span>
            </Link>
            <Link href="/education" className="text-white/70 max-sm:px-2 max-sm:py-1 px-4 py-2 max-sm:text-sm text-sm font-medium relative group transition-all duration-300 hover:text-white hover:scale-105 overflow-hidden rounded-full whitespace-nowrap">
              <div className="absolute top-1/4 left-1/4 w-1/4 h-1/2 bg-gradient-to-r from-yellow-400/0 via-yellow-400/20 to-yellow-400/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-500 ease-out opacity-0 group-hover:opacity-100"></div>
      ...
      {/* Simple Language Selector - Left Side of Navigation */}
      <div className="absolute max-sm:top-40 max-sm:left-48 max-sm:-translate-x-1/2 top-11 right-[270px] z-[99999] animate-on-scroll">
        <SimpleLanguageSelector currentLang="fa" />
      </div>
